...
/* arama utusuna birkelşme yazınca o kelimeyi içeren ürünleri filtrelemesi için */
  if (isset($_REQUEST["arama"])) {
    ...
    $sayfalama_kosulu ="&aranan=" . $gelenArama;
  }else{
    $gelenArama="";
    $aramaKosulu="";
    $sayfalama_kosulu ="";
...
<div class="UyeIslemlerAlani">
            ...
            <div class="HavaleSilIslemleri">
                <div class="HavaleSilMetni">Geri Aç</div>
                <div class="HavaleSilResim">
                   <a href="index.php?SKD=0&SKI=86&ID=<?php echo DonusumleriGeriDondur($uyeler["id"]); ?>"><img src="../img/geriac.png" border="0"></a>
                </div>
          </div>
</div>    <!-- üye işlemleri alanı--->
<?php
    }//for bitisi    
...
<div class="SayfalamaAlaniKapsayicisi">
     <div class="sayfalamaAlaniIciMetinAlaniKapsayicisi">
        Toplam <?php echo $bulunanSayfaSayisi; ?> sayfada, <?php echo $toplam_kayit_sayis; ?> adet kayıt bulunmaktadır.
     </div>
...
<?php
    ...
    ?>
<div class="BilgiAciklamaAlani">Kayıtlı silinmiş üye bulunmamaktadır.</div>
<?php
  }        
?>
